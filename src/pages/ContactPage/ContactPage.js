        ...
        <div className='contact-container'>
            ...
            <Form>
                    ...
                    ? <Row>
                        <Col>
                            <Form.Group controlId="formFullName">
                                ...
                                <Form.Control type="text" placeholder="Enter full name (required)" onChange={handleName} />
                            </Form.Group>
                        </Col>
                        <Col>
                            <Form.Group controlId="formSubjectOfEmail">
                                <Form.Label>Subject of email</Form.Label>
                                <Form.Control type="text" placeholder="Enter subject of email (optional)" onChange={handleSubject} />
                            </Form.Group>
                        </Col>
                    </Row>
                    : <div> 
                ...
                <Form.Group controlId="formMessage">
                    ...
                    <Form.Control as="textarea" rows="8" placeholder="Enter message (required)" onChange={handleMessage} />
                </Form.Group>
