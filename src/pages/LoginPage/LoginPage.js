    ...
    return (
        <div className='login-page-container'>
            <div className='login-container'>
                ...
                <Form>
                    <Form.Group controlId="formEmail">
                        ...
                        <Form.Control type="email" placeholder="Enter email" onChange={handleLoginEmail} />
                    </Form.Group>
            ...
            <div className='create-account-container'>
                <h1>New to SmartQ?</h1>
                <hr />
                <p>You track your in-store customer capacity, manage your queue lines virtually, schedule customers check-in times, and more!</p>
                ...
                <Form className='email-input'>
                    <Form.Group controlId="formEmail">
                        ...
                        <Form.Control type="email" placeholder="Enter email" onChange={handleSignUpEmail}/>
                    </Form.Group>
                </Form>
                <div className='button'>
                    <Button variant="primary" type="submit" onClick={redirectCreateAccount}>
                        Create account
                    </Button>
                </div>
            </div>
